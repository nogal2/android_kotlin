package com.example.bbssprrestful.dto

import android.os.Parcel
import android.os.Parcelable

data class BbsDto(val seq:Int, val id:String?, val ref:Int, val step:Int, val depth:Int, val title:String?, val content:String?, val wdate:String?,
                    val del:Int, val readcount:Int): Parcelable {
